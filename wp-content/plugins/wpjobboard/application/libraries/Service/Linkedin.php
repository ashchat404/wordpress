...
class Wpjb_Service_Linkedin {
    ...
    public static function dispatch($route)
    {
        ...
        if($applyFromLinkedin) {
            ...
            Wpjb_Project::getInstance()->getApplication("frontend")->controller->view->_flash->addInfo($m);
            Wpjb_Project::getInstance()->getApplication("frontend")->controller->redirect($job->url());
        }
    ...
    public static function footer()
    {
        ...
        <div id="wpjb-linkedin-connect" class="wpjb-overlay" style="display: none">
            <div>
                <h2 style="text-align: center; padding:45px 0px 15px 0px">
                    <img src="<?php esc_attr_e(plugins_url()."/wpjobboard/public/images/linkedin-logo-30px.png") ?>" alt="" />

...
class Wpjb_Form_Admin_Config_Linkedin extends Daq_Form_Abstract
{
    ...
    public function executePostSave($controller = null)
    {
        ...
        if($linkedin_api_key && $linkedin_oauth_token) {
            ...
            $e = $this->create("linkedin_apply_method", "select");
            $e->setLabel(__("Application Method", "wpjobboard"));
            //$e->addOption("email", "email", __("Email only", "wpjobboard"));
            //$e->addOption("url", "url", __("Save applications in DB", "wpjobboard"));
            //$e->addOption("apply", "apply", __(""Save Job Applications in DB", "wpjobboard"));
            //$e->addOption("prefill", "prefill", __("Prefill Apply Online Form Only, "wpjobboard"));
            $e->setValue($instance->getConfig("linkedin_apply_method", "apply"));
            //$this->addElement($e, "apply");

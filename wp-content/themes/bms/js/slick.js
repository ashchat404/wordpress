...
(function(factory) {
    ...
    Slick.prototype.buildArrows = function() {
        ...
        if (_.options.arrows === true && _.slideCount > _.options.slidesToShow) {
            ...
            _.$prevArrow = $(
                '<button type="button" class="slick-prev"><img src="<?php bloginfo("template_directory"); ?>/img/dir.png"></button>').appendTo(
                _.$slider);
            _.$nextArrow = $(
                '<button type="button" class="slick-next"><img src="<?php bloginfo("template_directory"); ?>/img/dir.png"></button>').appendTo(
                _.$slider);

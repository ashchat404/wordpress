<div class="where-am-i">
    <h2><?php _e('Membership', 'jobeleon'); ?></h2> 
</div><!-- .where-am-i -->
...
<div id="wpjb-main" class="wpjb-page-company-products">
    ...
    <table class="wpjb-table">
        <thead>
            <tr>
                <th style=""><?php _e("Product", "jobeleon") ?></th>
        ...
        <?php if (!empty($result)) : foreach($result as $pricing): ?>
            ...
            <tr class="">
                ...
                <td class="wpjb-last" style="vertical-align: top">
                    ...
                    <div>
                    <a href="<?php esc_attr_e(wpjb_link_to("membership", null, array("purchase"=>$pricing->id))) ?>" class="wpjb-button"><?php _e("Purchase", "jobeleon") ?></a>
                    </div>
                    <?php if($summary): ?>

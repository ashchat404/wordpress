            ...
            <table class="wpjb-info">
                <tbody>
                    <tr>
                        ...
                        <td><?php echo wpjb_date_display('d, l Y', $resume) ?></td>
                    </tr>
                    ...
                    <?php if ($resume->years_experience): ?>
                        <tr>
                            <td><?php _e("Experience", "jobeleon") ?></td>
                    ...
                    <?php if ($resume->category_id): ?>
                        <tr>
                            <td><?php _e("Category", "jobeleon") ?></td>

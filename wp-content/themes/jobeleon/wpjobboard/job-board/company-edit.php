...
<div class="where-am-i">
    <h2><?php _e('Edit employer', 'jobeleon'); ?></h2>
</div><!-- .where-am-i -->
...
<div id="wpjb-main" class="wpjb-page-company-edit">
    ...
    <div class="wpjb-menu-bar">
        <a href="<?php echo wpjb_link_to("company", $company) ?>" class="btn"><?php _e("View Profile", "jobeleon"); ?></a>
        <a href="<?php echo wpjb_link_to("employer_password") ?>" class="btn"><?php _e("Change Password", "jobeleon") ?></a> 
        <a href="<?php echo wpjb_link_to("employer_delete") ?>" class="btn"><?php _e("Delete Account", "jobeleon") ?></a> 
    </div>
    <?php endif; ?>

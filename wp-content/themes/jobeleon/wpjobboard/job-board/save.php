...
<div id="wpjb-main" class="wpjb-page-save">
    ...
    <?php if ($can_post): ?>
        ...
        <p class="wpjb-complete">
            ...
            <p><?php _e("Thank you for using our service and submitting your job listing.", "jobeleon") ?></p>

            <?php if ($online): ?>
                <p><?php _e("Your job listing is now live.", "jobeleon") ?></p>
                <p><a href="<?php echo wpjb_link_to("job", $job) ?>"><?php _e("Click here to view your listing", "jobeleon") ?></a></p>

            <?php else: ?>
                <p><?php _e("Once it has been moderated and approved your job posting will become active.", "jobeleon") ?></p>

            <?php endif; ?>

        <?php elseif ($action == "payment_complete"): ?>
            <?php _e("Thank you for the payment, your order will be processed shortly.", "jobeleon") ?>
        <?php elseif ($action == "payment_already_sent"): ?>
            <?php _e("We already recived payment for this listing. Thank you.", "jobeleon") ?>
        <?php else: // show payment form ?>
            <?php _e("Please use form below to make payment for job listing. Thank you!", "jobeleon") ?>

            <table class="wpjb-info" id="wpjb-payment">
                <tbody>
                    <tr>
                        <td><b><?php _e("Listing Cost", "jobeleon") ?>:</b></td>
